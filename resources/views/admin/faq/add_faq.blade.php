    ...
    <div class="row">
        <div class="col-md-12 grid-margin">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="font-weight-bold mb-0">Add Faq</h3>
                </div>
                <div>
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="faq_question" name="faq_question" placeholder="Question" value="{{ old('faq_question') }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="form-group">							  
                                ...
                                <textarea class="form-control" id="faq_answer" name="faq_answer" placeholder="Answer" rows="10">{{ old('faq_answer') }}</textarea>
							</div>
